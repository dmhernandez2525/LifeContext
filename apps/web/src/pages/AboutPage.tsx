      ...
      <section className="px-6 py-20 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Cognitive Extension</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Radical Intimacy</h3>
                  <p className="text-gray-400">
          ...
          <div className="relative">
            ...
            <div className="relative bg-gray-900 border border-white/10 rounded-3xl p-8 h-full">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-white/5 rounded-xl text-center flex items-center justify-center">
                   <span className="text-gray-500 italic">Join us?</span>
                </div>
              </div>
            </div>
          </div>
