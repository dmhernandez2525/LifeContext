        ...
        <div className="space-y-4 text-center">
          ...
          <div className="flex gap-3 justify-center">
            <a
              ...
              className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-6 py-3 rounded-xl font-medium hover:scale-105 transition-transform"
            >
        ...
        <div className="space-y-4 text-center">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            {[
              ...
              <div key={item.label} className="bg-gray-50 dark:bg-gray-800 p-3 rounded-xl text-left">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {/* Icon */}
              <div className={cn(
                "w-20 h-20 rounded-2xl bg-gradient-to-br mx-auto mb-6 flex items-center justify-center text-white",
